...
DB_DIR: str = os.path.join(ABS_PATH, "dbCopilot")
...
def main():
    ...
    st.title("🦜🔗 QA with CoPilot Reference")
    st.write('You MUST create your local Vector-Data at least once (takes ~30 seconds)...')
